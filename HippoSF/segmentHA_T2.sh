...
# partial volume correction.
  ...
  set suffix2 = $SUFFIX.
foreach hemi (lh rh)
  set txt=$SUBJECTS_DIR/$SUBJECTNAME/mri/$hemi.hippoSfVolumes-$ANALYSISID.$SUFFIX.txt
  ...
  set txt=$SUBJECTS_DIR/$SUBJECTNAME/mri/$hemi.amygNucVolumes-$ANALYSISID.$SUFFIX.txt
